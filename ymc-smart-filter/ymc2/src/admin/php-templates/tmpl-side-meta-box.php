...
<ol class="list-items">
    ...
    <li><?php echo esc_html__('Installation of different types of pagination (Numeric, Load more, Infinite scroll).','ymc-smart-filter'); ?></li>
    ...
    <li><?php echo esc_html__('Setting up a grid of posts (columns, spacing, responsive breakpoints).','ymc-smart-filter'); ?></li>
    ...
    <li><?php echo esc_html__('Support Masonry Layout and justified grids.','ymc-smart-filter'); ?></li>
    ...
    <li><?php echo esc_html__('Compatible with multilingual WPML and Polylang plugins.','ymc-smart-filter'); ?></li>
    <li><?php echo esc_html__('Constructor for creating combined filters (mixing multiple filter types in one grid).','ymc-smart-filter'); ?></li>
...
<a class="button button--primary" href="https://github.com/YMC-22/Filter-Grids" target="_blank" style="background-color: #032f3f;">
