...
= 3.12.12 =
Fixed: Security Layout Render.
= 3.12.10 =
Security improvements.
Props to Usama Arshad and Artus KG for responsibly reporting security issues.
= 3.12.9 =
Security: Improved SVG upload validation.
= 3.12.8 =
Security: Fixed privilege escalation in Layout Builder schema saving by enforcing per-filter capability checks.
= 3.12.7 =
Security: Improved access validation for post statuses in Grid and Popup. Added a developer filter to customize guest popup access.
= 3.12.6 =
Security: Improved access validation for the popup REST API endpoint.
= 3.12.3 =
