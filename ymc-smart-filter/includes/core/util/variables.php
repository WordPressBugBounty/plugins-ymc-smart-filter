...
$ymc_featured_posts = $variable->get_featured_posts( $id );
$ymc_featured_post_layout = $variable->get_featured_post_layout( $id );
$ymc_location_featured_posts = $variable->get_location_featured_posts( $id );
$ymc_featured_post_status = $variable->get_featured_post_status( $id );
...
$ymc_order_term_by   = $variable->get_order_term_by( $id );
